 ...
 * @since 1.0
 * 
 *        This class represents a login page, the first frame you see when you
 *        start the application
 * 
 *        <p>
 *        From the LoginPage, if you log in with the correct credentials, you
 *        will be taken to the home page, there is also an option for forget
