 ...
 * @since 1.0
 * 
 *        This class represents the basic template for a Point of Interest in
 *        our map application.
 * 
 *        <p>
 *        From the POI class, there can either be Built in POIs in the western
 *        university maps, or a custom POI that a user creates. Each POI
 *        regardless of custom or not has a a floor that it is on and is
 *        associated with.
 *        <p>
 */
public class POI {
