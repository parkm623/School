...
# Register address and name to the discovery server

def register():
    msg = "REGISTER " + str(room_socket.getsockname()[1]) + ' ' + name
    room_socket.sendto(msg.encode(), discovery)
...
# Deregister address and name to the discovery server
...
def main():
    ...
    parser.add_argument("-n", help="connecting room to the north", metavar="serverName", default="")
    parser.add_argument("-s", help="connecting room to the south", metavar="serverName", default="")
    parser.add_argument("-e", help="connecting room to the east", metavar="serverName", default="")
    parser.add_argument("-w", help="connecting room to the west", metavar="serverName", default="")
    parser.add_argument("-u", help="connecting room upwards", metavar="serverName", default="")
    parser.add_argument("-d", help="connecting room downwards", metavar="serverName", default="")
    ...
    # Register the room to the discovery server
