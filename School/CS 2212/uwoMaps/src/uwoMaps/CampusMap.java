 ...
 * 
 *        <p>
 *        CampusMap class is base of our map application. It has building list
 *        which contain our main 3 buildings.
 *        <p>
 */
public class CampusMap extends JFrame implements ActionListener {
	...
	/*
	 * Constructor that initializes all the instance variables setting the button
	 * and list frame
	 */
	public CampusMap() {
		...
		// added by dalter4@uwo.ca, checks the userdata if user can edit and sets the
		// variable
	...
	/**
	 * Test the button addBtn call the addBuilding method removeBtn call the
	 * removeBuilding method helpBtn call the Housekeeping class/frame buildingBtn
	 * show the list of current building list
	 */
