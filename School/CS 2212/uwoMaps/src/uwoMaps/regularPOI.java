 ...
 * @version 1.0 This class will be used to create regular POIs
 */

public class regularPOI extends POI {

	/*
	 * MetaData object associated with the built in point of interest, This is not a
	 * required instance variable for all regular POIs, only for regularPOIs of the
	 * classroom category.
	 */
	private MetaData metadata;

	/*
	 * The categories of the Built in POI can be classroom, navigation, washroom,
	 * CS, eateries, etc
	 */
	private String category;
	/*
	 * The description is any extra details for the category: navigation(stairwell,
	 * door, or elevator), CS(computer lab, and collaborative room), washroom (male
	 * or female), etc
	 */
